...
public class Main {
	public static void main(String[] args) {
		...
		SquatFrame goodBodyFrame = new SquatFrame(goodBodyParam[0],
				goodBodyParam[1], goodBodyParam[2], goodBodyParam[3],
				goodBodyParam[4]);
		...
		SquatFrame testAngleFrame = new SquatFrame(testAngleParam[0],
				testAngleParam[1], testAngleParam[2], testAngleParam[3],
				testAngleParam[4]);
