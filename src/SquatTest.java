...
public class SquatTest {
    ...
    public void testFindFirstFrame() throws Exception {
        ...
        squat.findFirstFrame();
    }

    @Test
    public void testFindLastFrame() throws Exception {
        SquatFrame sf1 = new SquatFrame(new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0));
        SquatFrame sf2 = new SquatFrame(new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0));
        SquatFrame sf3 = new SquatFrame(new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0));
        SquatFrame sf4 = new SquatFrame(new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0));
        SquatFrame sf5 = new SquatFrame(new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0));
        SquatFrame sf6 = new SquatFrame(new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0));
        SquatFrame sf7 = new SquatFrame(new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0));
        SquatFrame sf8 = new SquatFrame(new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0));
        SquatFrame sf9 = new SquatFrame(new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0));
    ...
    @Test
    public void testFindMiddleFrame() throws Exception {
        SquatFrame sf1 = new SquatFrame(new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0));
        SquatFrame sf2 = new SquatFrame(new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0));
        SquatFrame sf3 = new SquatFrame(new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0));
        SquatFrame sf4 = new SquatFrame(new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0));
